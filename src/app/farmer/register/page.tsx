...
export default function FarmerRegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col justify-between py-8 px-4 sm:px-6 lg:px-8 selection:bg-emerald-500 selection:text-white font-sans">
      ...
      <div className="max-w-xl w-full mx-auto my-6">
        <Card className="bg-white border border-slate-200 p-8 shadow-xs rounded-2xl">
              ...
              <div className="space-y-4 animate-in fade-in">
                <div>
                  ...
                  <input
                    type="text"
                    {...register('fullName')}
                    className="w-full bg-white border border-slate-200 focus:border-emerald-500 rounded-xl px-4 py-2.5 text-sm text-slate-900 outline-none"
                  />
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-white border border-slate-200 focus:border-emerald-500 rounded-xl px-4 py-2.5 text-sm text-slate-900 outline-none font-bold"
                  >
                ...
                <Button type="button" onClick={nextStep} className="w-full py-3 mt-4 bg-emerald-600 hover:bg-emerald-500 text-white font-bold">
            ...
            {step === 2 && (
              <div className="space-y-4 animate-in fade-in">
                ...
                <div className="flex gap-3 mt-4">
                  ...
                  <Button type="button" onClick={nextStep} className="flex-1 bg-emerald-600 hover:bg-emerald-500 text-white font-bold">
                    {t('next')}: Crops &rarr;
                  </Button>
                </div>
              </div>
            ...
            {step === 3 && (
              <div className="space-y-4 animate-in fade-in">
                ...
                <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-4 text-xs text-emerald-800 space-y-1">
                  <span className="font-bold text-emerald-700 block mb-1">✓ Setup Ready</span>
                  <p>Your farmer profile will be securely registered in the AgriFlow network with full market access.</p>
                </div>
                ...
                <div className="flex gap-3 mt-4">
                  ...
                  <Button type="submit" isLoading={isSubmitting} className="flex-1 bg-emerald-600 hover:bg-emerald-500 text-white font-bold">
          ...
          <div className="mt-6 pt-4 border-t border-slate-200 text-center text-xs text-slate-500">
            ...
            <Link href="/farmer/login" className="text-emerald-600 font-bold hover:underline">
              {t('login')} Here
            </Link>
          </div>
